// src/sections/StayConnected.tsx
...
const StayConnected: React.FC = () => {
  ...
  return (
    <section className="flex justify-center bg-[#FEFEFE] py-24 px-60
                        max-2xl:px-[5vw] max-md:py-12 max-sm:px-4">
      {/* rainbow gradient border */}
      <div className="relative w-full rounded-xl p-[2px]">
        <div className="absolute inset-0 rounded-xl bg-gradient-to-r
                        from-red-500 via-yellow-400 to-violet-600" />
        <div className="relative z-10 flex w-full flex-wrap
                        gap-6 rounded-xl bg-white p-12
                        max-lg:p-8 max-md:p-6">
          {/* ---- header ---- */}
          <div className="flex w-full flex-col gap-2
                          lg:flex-row lg:items-center lg:justify-between">
            <h2 className="text-4xl font-extrabold tracking-tight
                           max-md:text-3xl">Stay&nbsp;Connected</h2>
          ...
          >
            ...
            <div className="flex flex-1 items-center rounded-lg
              ...
              <input
                ...
                maxLength={10}
                className="w-full flex-1 rounded-r-lg px-6 py-3
