      ...
      >
        ...
        <div
          className="
            ...
            max-[1750px]:px-[clamp(16px,3vw,32px)]
            max-[1750px]:text-center
            max-[1750px]:items-center
            max-[1750px]:justify-center
          "
        >
          {/* ---------- Image ----------------------------------------- */}
          <div
          ...
          >
            ...
            <p className="text-[clamp(18px,2.5vw,24px)] font-medium">
            ...
            <div
              className="
                ...
                max-[1750px]:justify-center
                max-[764px]:gap-[clamp(6px,1vw,12px)]
              "
            >
              {benefits.map(({ title }) => (
                <div
                  ...
                  className="
                    ...
                    /* size & spacing – desktop ----------------------- */
                    w-[clamp(120px,25vw,200px)]
                    py-[clamp(16px,2vw,34px)]
                    ...
                    max-[764px]:py-[clamp(12px,2vw,16px)]
                    max-[764px]:px-0
                    max-[764px]:text-[clamp(12px,2vw,14px)]

                    /* ≤500 px  -------------------------------------- */
                    max-[500px]:w-[calc(33.333%-8px)]
                    max-[500px]:py-[clamp(8px,1.5vw,12px)]
                    max-[500px]:px-0
                ...
                >
                  <img
                    ...
                    className="
                      ...
                      max-[764px]:h-[clamp(10px,2vw,16px)]
                      max-[764px]:w-[clamp(10px,2vw,16px)]

                      max-[500px]:h-[clamp(14px,3vw,20px)]
                      max-[500px]:w-[clamp(14px,3vw,20px)]
                    "
                  />
                  <p
                    className="
