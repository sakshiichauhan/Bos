      ...
      <div className="text-center w-full max-w-[1440px] px-4">
        <h2 className="mb-4">
          <div className="flex flex-col items-center">
            <span className="text-[clamp(32px,5vw,48px)] font-bold text-[#111]">
              Upcoming BOS
            </span>
            <span className="text-[clamp(32px,5vw,48px)] font-semibold text-[#222]">
              Events Around You
            </span>
          </div>
        </h2>
        <p className="text-[clamp(14px,2.5vw,20px)] text-[#444] leading-[1.75] mt-4">
