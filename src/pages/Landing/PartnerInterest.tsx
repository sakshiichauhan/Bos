...
/* identical gradient-border backgrounds (border-image) */
...
const PartnersSection: FC = () => {
  ...
  return (
    <section
      ...
      /*---------- SECTION ------------------------------------------------*/
      className="
        bg-[#F8F8F8] text-center
        px-[190px] py-[64px]                            /* desktop base */
        max-[1360px]:px-[120px] max-[1360px]:py-[48px]  /* ≤1360 px   */
        max-[1024px]:px-[80px]  max-[1024px]:py-[60px]  /* ≤1024 px   */
        max-[768px]:px-[16px]   max-[768px]:py-[40px]   /* ≤768 px    */
      "
    >
      {/*----------- HEADLINE ---------------------------------------------*/}
      <h2
      ...
      <p
        className="
          mb-[72px] text-[25px]
          max-[1360px]:text-[20px] max-[1360px]:mb-[56px]
          max-[768px]:text-[14px]  max-[768px]:mb-[48px]
        "
      >
      ...
      <div
        className="
          mb-[32px] flex flex-wrap justify-center gap-[24px]
          max-[1024px]:gap-[20px]
          max-[768px]:flex-col max-[768px]:gap-[34px]
        "
      >
        {partners.map(({ title, icon, color }) => (
          <div
            key={title}
            style={{ background: gradients[color] }}         /* gradient border */
            className="
              relative flex flex-col justify-start
              w-[283px] min-h-[232px]
              px-[24px] pt-[56px] pb-[32px]
              border-[2px] border-transparent rounded-[16px]
              font-semibold text-[16px] text-left
              transition-transform duration-200 hover:-translate-y-1

              max-[1360px]:w-[250px] max-[1360px]:pt-[48px] max-[1360px]:pb-[28px] max-[1360px]:text-[15px]

              max-[1024px]:w-[45%]                         /* two-up at ≤1024 px */
              max-[768px]:w-full max-[768px]:px-[16px]      /* 100 % on mobile   */
              max-[768px]:pt-[40px] max-[768px]:pb-[24px] max-[768px]:text-center
            "
          >
            {/*------ ICON BOX --------------------------------------------*/}
            <span
              className="
                absolute -top-[40px] left-[24px]               /* ≥1050 px */
                bg-white p-[14px] rounded-[9px] border border-[#DFDFDF] shadow-md

                max-[1360px]:-top-[36px] max-[1360px]:p-[12px]

                max-[1050px]:left-1/2 max-[1050px]:-translate-x-1/2
                max-[1050px]:transform
                max-[1050px]:top-[-40px]
            ...
            >
              <img
                ...
                className="
                  ...
                  max-[1360px]:w-[44px] max-[1360px]:h-[44px]
            ...
            <p
              className="
                text-[28px] leading-snug w-[85%]
                max-[1360px]:text-[24px] max-[1360px]:w-[90%]
                max-[768px]:text-[20px]  max-[768px]:w-full
                max-[768px]:mt-[24px]   max-[768px]:mb-[24px]
              "
            >
              {title}
            </p>
      ...
      <p
        className="
          mb-[32px] text-[20px] text-gray-500
          max-[1360px]:text-[18px] max-[1360px]:mb-[28px]
          max-[768px]:text-[14px]  max-[768px]:mb-[24px] max-[768px]:px-[16px]
        "
      >
